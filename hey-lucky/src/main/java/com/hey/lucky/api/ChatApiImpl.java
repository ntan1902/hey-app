...
public class ChatApiImpl implements ChatApi {
    ...
    @Override
    public boolean createLuckyMoneyMessage(CreateLuckyMoneyMessageRequest request) throws ErrCallChatApiException {
    ...
    @Override
    public boolean createReceiveLuckyMoneyMessage(CreateReceiveLuckyMoneyMessageRequest request) throws ErrCallChatApiException {
        log.info("Inside createTransferMessage of ChatApiImpl: {}", request);
