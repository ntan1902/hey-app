...
export default (state = initialState, action = {}) => {
    switch (action.type) {
        ...
        case actionTypes.NEW_TRANSFER_STATEMENT:
            return {
                ...state,
                transferStatements: [action.transferStatement, ...state.transferStatements],
            };
        case actionTypes.LOAD_MORE_TRANSFER_STATEMENT:
            return {
                ...state,
                transferStatements: [...state.transferStatements, ...action.moreTransferStatement]
            }
        default:
            return {...state };
    }
